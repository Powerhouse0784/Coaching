          ...
          <div className="space-y-6">
            ...
            <div className={`${darkMode ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'} rounded-2xl border-2 p-6 hover:shadow-xl transition-shadow duration-300`}>
              ...
              <div className="flex gap-3">
                ...
                <a href="https://youtube.com/@intense_learners?si=PKpm1w_PnuAImiYG" className="w-10 h-10 bg-blue-100 dark:bg-blue-900/30 text-blue-400 dark:text-blue-400 rounded-lg flex items-center justify-center hover:scale-110 hover:rotate-6 transition-all duration-300">
